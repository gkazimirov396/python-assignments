...
salary_raise = int(
    input('Яке ваше очікуване підвищення зарплати?: '))
...
if with_loan == 'y':
    ...
    if monthly_payment > salary:
        ...
        print(f'Та ж квартира коштує ${real_estate_price}, відсотки по кредиту - {annual_interest_rate}% річних. Якщо ви берете кредит на {formatted_loan_term}, то маєте сумарно виплатити ${loan_amount}. Загальна сума стає ${total_amount}, без стартового внеску ${down_payment_percentage} або ${monthly_payment:.2f} щомісяця за {formatted_loan_term}.')
